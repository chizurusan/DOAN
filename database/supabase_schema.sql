...
-- Extensions
-- pgcrypto already enabled in Supabase
CREATE EXTENSION IF NOT EXISTS "pg_trgm"; -- Enable this in Supabase Dashboard > Database > Extensions
...
-- ============================================================
-- AUTO-CREATE public.users WHEN SUPABASE AUTH USER SIGNS UP
-- ============================================================
...
-- users.id references Supabase Auth (auth.users)
...
-- -------------------------------------------------------
-- USERS
-- NOTE: Create these users via Supabase Auth Dashboard first,
-- then copy their UUIDs here. The handle_new_user trigger
-- will auto-insert into public.users on signup.
-- Placeholder seed below uses fixed UUIDs for dev/testing only.
-- -------------------------------------------------------
-- INSERT INTO users (id, email, phone, full_name, status, email_verified_at)
-- VALUES
--     ('e0000000-0000-0000-0000-000000000001', 'admin@roomify.vn',    '0900000001', 'Roomify Admin',      'active', NOW()),
--     ('e0000000-0000-0000-0000-000000000002', 'owner@roomify.vn',    '0900000002', 'Nguyen Van Owner',   'active', NOW()),
--     ('e0000000-0000-0000-0000-000000000003', 'customer@roomify.vn', '0900000003', 'Tran Thi Customer',  'active', NOW());
-- Uncomment and replace UUIDs after creating users in Supabase Auth Dashboard.


-- -------------------------------------------------------
-- USER ROLE ASSIGNMENTS
-- NOTE: Thêm sau khi tạo user qua Supabase Auth Dashboard
-- -------------------------------------------------------
